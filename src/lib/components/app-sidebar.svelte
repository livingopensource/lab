              ...
              {#snippet child({ props })}
                ...
                >
                  ...
                  <div class="grid grid-cols-1">
                    <div>{$page.data.session?.user?.name ?? "NA"}</div>
                    <div>{$page.data.session?.user?.email ?? "NA"}</div>
                  </div>
